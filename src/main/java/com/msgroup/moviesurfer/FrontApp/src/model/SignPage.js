        ...
        <div className="first-form-wrapper">
          ...
          <div>
            <Alert
              className="mt-3"
              color="success"
              isOpen={signSuccessAlert}
              toggle={showSignSuccess}
            >
            ...
            <Alert
              className="mt-3"
              color="danger"
              isOpen={signFailedAlert}
              toggle={showSignFailed}
            >
        ...
        <div className="second-form-wrapper">
          ...
          <div>
            <Alert
              className="mt-3"
              color="success"
              isOpen={regSuccessAlert}
              toggle={showRegisterSuccess}
            >
            ...
            <Alert
              className="mt-3"
              color="danger"
              isOpen={regFailedAlert}
              toggle={showRegisterFailed}
            >
